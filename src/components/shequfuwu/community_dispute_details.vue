          ...
          <el-col>
            <div class="chayueleft">
              <el-row class="yuyuetop">
                <el-col :span="8" style="text-align:center;">房屋使用权（教育路九耀坊巷005号-101）</el-col>
                <el-col :span="8" style="text-align:center;">添加时间：2019.12.02  19:10:13</el-col>
              ...
              <div class="eleContractContent">
                ...
                <div class="showSteps">
                  ...
                  <div class="step_item">
                    <div style="margin:10px;"><b>已派人协调</b></div>
