<template>
  <section>
    <el-form :inline="true" :model="formSearch" class="form_inline">
      ...
      <el-form-item label="概要" size="small">
      ...
      <el-form-item label="申请地址" size="small">
        <el-input v-model="formSearch.aa" placeholder="请输入内容"></el-input>
      </el-form-item>
    ...
    <el-table :data="formData" style="width: 100%" stripe>
      ...
      <el-table-column prop="item5"label="申请部门"></el-table-column>
      ...
      <el-table-column prop="item11"label="处理时间"></el-table-column>
      <el-table-column label="操作" fixed="right" width=250>
				<template slot-scope="scope">
					<el-button type="warning" size="small" @click="updateShowBox(scope.row)">下 发</el-button>
					<el-button type="warning" size="small" @click="updateShowBox(scope.row)">驳 回</el-button>
					<el-button type="warning" size="small"  @click="godetails">查看详情</el-button>
				</template>
			</el-table-column>
    </el-table>
