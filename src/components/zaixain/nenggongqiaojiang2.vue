...
import {getgenreid,getlishopinfo,praisecraftsman,xqSelectList,orgTree } from '../../url/api';
export default {
  data(){
    return{
      checkStrictly:false,
  ...
  methods:{
    getlist(){
      this.formSearch.fkId = this.$route.query.fkId
      praisecraftsman(this.formSearch).then((res)=>{
        console.log(res)
